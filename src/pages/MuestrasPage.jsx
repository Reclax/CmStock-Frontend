  ...
  const captureAndUpload = async () => {
    ...
    canvas.toBlob(
      async (blob) => {
        ...
        const file = new File(
          [blob],
          `camara-${editing.referencia}-${Date.now()}.jpg`,
          { type: "image/jpeg" },
        );
        setUploadingPhoto(true);
        try {
          ...
          <form className="grid gap-4 sm:grid-cols-2" onSubmit={onSubmit}>
            ...
            <FieldWrap label="Moldería (nombre libre)">
              <input
                ...
                required
                value={form.molderia || ""}
                onChange={(e) => onChange("molderia", e.target.value)}
                placeholder="Nombre de la moldería"
              />
            </FieldWrap>
            ...
            <FieldWrap label="DIMA">
              <input
                className={inputCls}
                value={form.dima || ""}
                onChange={(e) => onChange("dima", e.target.value)}
                placeholder="Código DIMA"
              />
            </FieldWrap>
            ...
            <FieldWrap label="Moldería">
              <select
                ...
                onChange={(e) => onChange("molderiaid", e.target.value)}
              >
            ...
            <FieldWrap label="Ubicación">
              <select
                ...
                onChange={(e) => onChange("ubicacionid", e.target.value)}
              >
            ...
            <FieldWrap label="Diseñador">
              <select
                ...
                onChange={(e) => onChange("disenadorid", e.target.value)}
              >
            ...
            <FieldWrap label="Proceso">
              <input
                ...
                placeholder="Proceso productivo"
              />
            </FieldWrap>
            ...
            <div className="col-span-full flex justify-end gap-3 border-t border-slate-100 pt-4">
              ...
              <button
                type="submit"
                className="inline-flex items-center gap-2 rounded-xl bg-[#1B3D8F] px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-[#163272] active:scale-[0.98]"
              >
